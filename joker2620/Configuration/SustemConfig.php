...
$config = [
     ...
     *
     * Используемая верссия VK API
     */
    'VK_VERSION' => 5.67, //Используемая версия API
    /**
     * Адрес VK API
     *
     * На данный адрес будут уходить все запросы направленные к VK API
     */
    'VK_ENDPOINT' => 'https://api.vk.com/method/', //Вк апи
    /**
